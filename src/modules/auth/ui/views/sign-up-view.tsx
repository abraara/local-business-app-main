               ...
               <Form {...form} >
                ...
                className="flex flex-col gap-8 p-4 lg:p-16">
                        <div className="flex items-center justify-between mb-8">
                            <Link href='/'>
                            <span className={cn("text-2xl font-semibold")}>ShopLocal</span>
                            </Link>
                            <Button
                            asChild
                            variant="ghost"
                        ...
                        <h1 className="text-4xl font-medium">
                            Join ShopLocal and start selling today
                        </h1>
                        <FormField 
                         name="username"
                         render={({ field }) => (
                         ...
                         size="lg"
                         variant="elevated"
                         className="w-full bg-black text-white hover:bg-pink-400 hover:text-primary cursor-pointer"
                         >
                            Create account
                         </Button>
                </form>
